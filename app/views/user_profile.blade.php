...
<div class="container">
  ...
  <div id="password_error" style="display:none;">{{ Session::get('password_error') }}</div>
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="tabbable">
        <ul class="nav nav-tabs">
          ...
          <li class=""><a href="#tab1-4" data-toggle="tab"><i class="fa fa-unlock"></i>Cambiar contraseña</a></li>
        ...
        <div class="tab-pane" id="tab1-4">
          <div class="row">
            ...
            <div class="row">
              <div class="form-group">
                {{ Form::label('password', 'Contraseña actual', array('class' => 'col-md-2 control-label')) }}
                <div class="col-md-2" class="error">
                  {{ Form::password('old_password', array('class' => 'session form-control')) }}
                </div>
...
<script>
  $(document).ready(function(){
    ...
    if ($("#password_error").text() == '1') {
      $('.nav-tabs a[href="#tab1-4"]').tab('show');
    }
