			...
			<div class="container" style="background-color: #0ab2db;margin-left: 0px;margin-right: 0px;padding-left: 0px;padding-right: 0px;width: 100%;">
			    <div class="row" style="margin-left: 0px; margin-right: 0px; width: 1265px;">
			        <div class="col-md-2">
				        <!-- Logo --> 
				        <center>                      
				      		<a href="index.php" title="Home"><img src="images/Tj.png" style="width: 48%; height:48%; vertical-align:text-bottom; padding:10px 10px 10px 10px;" alt=""></a>
				        </center>
			        </div>

			        <div class="col-md-10">
			    	<!-- Nav -->
			 		   	<div id="undefined-sticky-wrapper" class="sticky-wrapper" style="height: 40px;"><nav class="navbar" role="navigation" style="width: 100%;">
			   	 		 	<div class="navbar-inner">
								<ul class="top-items">
									<li><a href="#"> Regístrate</a> - <a href="#" data-toggle="modal" data-target="#myModal"> Inicia sesión</a></li>
									<li><img alt="Us" src="http://dth47yrmvyy2b.cloudfront.net/assets/us-18a88499b91dedb13ab9196f28d6ea04.png"></li>
									<li><img alt="Mx" src="http://dth47yrmvyy2b.cloudfront.net/assets/mx-467cfd7fc184481b9849f1831e42d4a1.png"></li>
								</ul>
