				    ...
				    <div class="row">
				        ...
				        <div class="col-md-1">                    
					      	<a href="index.php" title="Home">
					      		<img src="images/Logo_Tj.png" style="vertical-align:text-bottom; padding:10px 8px 10px 0px;" alt="">
					      	</a>
				        </div>
						    ...
						    <div align="right">	
						    	<ul>
									<li id="username-li">
										...
										<?php } ?>
										&nbsp;<a href="index.php?lang=es"><img alt="Us" src="images/icon_es.png" style="width: 3%;"></a>
										&nbsp;<a href="index.php?lang=en"><img alt="Mx" src="images/icon_in.jpg" style="width: 3%;"></a>
									</li>
								</ul>
							</div>
